                ...
                <ul className="flex items-center space-x-2">
                    ...
                    {Array.from({ length: Math.ceil(totalItems / perPage) }, (_, index) => (
                        <li key={index} onClick={() => handlePageChange(index + 1)} >
                            <a href="#" className={`${currentPage === index + 1 && 'text-white border border-blue-300 bg-stone-700 '} hover:bg-stone-700 hover:text-white py-4 px-5 leading-tight bg-white border border-gray-300 `}>{index + 1}</a>
                        </li>
                    ))}
