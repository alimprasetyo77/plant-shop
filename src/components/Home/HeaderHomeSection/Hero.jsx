...
const Hero = () => {
    return (
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 '>
            <div className='max-w-4xl flex flex-col text-center items-center gap-y-8 px-8 font-Roboto'>
                <h3 className='font-bold uppercase tracking-[2px]'>welcome to greenstore</h3>
