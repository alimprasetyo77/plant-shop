        ...
        <div className="p-4 absolute bottom-0 w-full space-y-6">
          ...
          <div className="flex flex-col gap-y-4">
            {cartItems.length > 0 ?
              <>
                <Link to={'/cart'}>
                  <Button className={'bg-[#FF5100] text-white w-full'}>View Cart</Button>
                </Link>
                <Button className={'bg-[#FF5100] text-white w-full'}>Checkout</Button>
              </>
              :

              <Button className={'bg-[#FF5100] text-white w-full'} onClick={() => setCartOpen(false)}>Continue Shopping</Button>
            }
          </div>
        </div>
      </div >
